    ...
    <>
      ...
      <div className="w-full md:w-1/2 space-y-8">
        <motion.div variants={fadeIn('right', 0.2)} initial="hidden" whileInView="show">
          {/* Star badge */}
          <div className="flex items-center gap-2 bg-gray-50 w-fit px-4 py-2 rounded-full hover:bg-purple-200 transition-colors cursor-pointer group">
            <span className="text-purple-600 group-hover:scale-110 transition-transform">★</span>
            <span className="text-sm font-medium">Jump start your growth</span>
          </div>
        </motion.div>
{/* Fueling Growth from Village Roots to Agri-Tech Heights. */}
        <motion.h1 
        ...
        >
          Fueling Growth from Village Roots{' '}
        ...
        >
          Get real-time updates, agri-tools, expert tips, and marketplace access — all in one powerful solution.
        </motion.p>
        ...
        >
          ...
          />
          <button className="bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-blue-700 cursor-pointer transition-all hover:shadow-lg hover:shadow-blue-100 active:scale-95">
            →
          </button>
        </motion.div>
      </div>
